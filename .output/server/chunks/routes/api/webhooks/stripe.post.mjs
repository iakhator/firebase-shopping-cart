import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { d as defineEventHandler, j as readRawBody, f as adminFirestore } from '../../../nitro/nitro.mjs';
...
var stripe_post_default = defineEventHandler(async (event) => {
  ...
  if (stripeEvent.type === "payment_intent.succeeded") {
    try {
      ...
      const { userId, items, orderId, customerName, shippingAddress } = paymentIntent.metadata;

import { u as useRoute, g as useRouter, _ as __nuxt_component_4 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    computed(() => orderStore.order);
    computed(() => orderStore.isLoading);
...
const success = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ddb8ea50"]]);

export { success as default };
//# sourceMappingURL=success-I3nTUr78.mjs.map

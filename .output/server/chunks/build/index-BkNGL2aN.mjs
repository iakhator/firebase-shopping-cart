import { defineComponent, useAttrs as useAttrs$1, useSlots, computed, shallowRef, ref, watch, nextTick, toRef, createElementBlock, openBlock, normalizeStyle, normalizeClass, unref, createCommentVNode, Fragment, createElementVNode, renderSlot, createBlock, withCtx, resolveDynamicComponent, mergeProps, withModifiers, createVNode, toDisplayString, getCurrentInstance } from 'vue';
import { useResizeObserver, useEventListener, isClient } from '@vueuse/core';
import { isNil, fromPairs } from 'lodash-unified';
import { w as withInstall, _ as _export_sfc, j as buildProps, y as useFormSize, J as useFormDisabled, K as useFormItem, A as useFormItemInputId, V as ValidateComponentsMap, L as view_default, M as hide_default, a as ElIcon, N as circle_close_default, n as definePropType, o as iconPropType, B as useSizeProp } from './el-button-etDYgHTt.mjs';
import { h as useNamespace, s as debugWarn, p as isNumber } from './server.mjs';
import { u as useAriaProps, m as mutable, i as isFocusable } from './typescript-B4MtqadT.mjs';
...
function useFocusController(target, {
  ...
  const handleClick = (event) => {
    var _a, _b;
    if (((_a = wrapperRef.value) == null ? void 0 : _a.contains((void 0).activeElement)) && wrapperRef.value !== (void 0).activeElement || isFocusable(event.target) || disabled.value)
      return;
...
//# sourceMappingURL=index-BkNGL2aN.mjs.map

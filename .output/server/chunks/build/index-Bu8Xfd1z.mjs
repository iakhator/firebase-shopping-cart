import { defineComponent, inject, withDirectives, cloneVNode, renderSlot, ref, provide, watch, unref, Fragment, Text, Comment, createBlock, openBlock, Teleport as Teleport$1, createVNode, toRef, computed, readonly, withCtx, createCommentVNode, createElementBlock, toDisplayString, nextTick, reactive, normalizeClass, createElementVNode, normalizeStyle, resolveDynamicComponent, getCurrentInstance, Transition, mergeProps, vShow, withModifiers, shallowRef } from 'vue';
import { w as withInstall, _ as _export_sfc, j as buildProps, n as definePropType, l as addUnit, s as buildProp, t as formItemContextKey } from './el-button-etDYgHTt.mjs';
import { placements, createPopper } from '@popperjs/core';
import { u as useAriaProps, i as isFocusable } from './typescript-B4MtqadT.mjs';
import { u as useDelayedToggleProps, a as useDelayedToggle } from './index-BKHcXdi2.mjs';
import { E as EVENT_CODE } from './aria-DC1XP1AM.mjs';
import { C as isElement, h as useNamespace, f as useId, i as isBoolean, p as isNumber, D as useGetDerivedNamespace, E as useIdInjection, y as throwError, e as useZIndex } from './server.mjs';
import { NOOP, isObject, isFunction, isArray } from '@vue/shared';
import { useResizeObserver, useEventListener, computedEager, onClickOutside, isClient, unrefElement } from '@vueuse/core';
import { isNil, isUndefined, fromPairs } from 'lodash-unified';
...
var ElFocusTrap = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render], ["__file", "focus-trap.vue"]]);
...
var Teleport = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__file", "teleport.vue"]]);
...
export { ElTeleport as E, FOCUS_TRAP_INJECTION_KEY as F, OnlyChild as O, ElFocusTrap as a, ElTooltip as b, composeEventHandlers as c, ElScrollbar as d, useTooltipTriggerProps as e, roleTypes as r, scrollbarEmits as s, teleportProps as t, useTooltipContentProps as u, whenMouse as w };
//# sourceMappingURL=index-Bu8Xfd1z.mjs.map

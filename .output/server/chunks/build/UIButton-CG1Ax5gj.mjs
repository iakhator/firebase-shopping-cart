import { d as ElButton } from './el-button-V0v0dsgs.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_button, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="mr-2" data-v-83f75c16${_scopeId}>`);
...
const UIButton = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-83f75c16"]]);

export { UIButton as U };
//# sourceMappingURL=UIButton-CG1Ax5gj.mjs.map

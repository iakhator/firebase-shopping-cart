import { defineComponent, createElementBlock, openBlock, withModifiers, normalizeStyle, normalizeClass, renderSlot, inject, computed, resolveComponent, createBlock, withCtx, createVNode, mergeProps, getCurrentInstance, ref, unref, createCommentVNode, createSlots, watch, provide, toRef, Fragment, createElementVNode, resolveDynamicComponent, nextTick, normalizeProps, guardReactiveProps, readonly } from 'vue';
import { w as withInstall, v as withNoopInstall, _ as _export_sfc, j as buildProps, x as arrow_down_default, a as ElIcon, E as ElButton, k as useLocale, l as addUnit, y as useFormSize, n as definePropType, o as iconPropType } from './el-button-etDYgHTt.mjs';
import { F as FOCUS_TRAP_INJECTION_KEY, c as composeEventHandlers, O as OnlyChild, b as ElTooltip, d as ElScrollbar, u as useTooltipContentProps, r as roleTypes, e as useTooltipTriggerProps, w as whenMouse } from './index-Bu8Xfd1z.mjs';
import { useEventListener } from '@vueuse/core';
import { E as EVENT_CODE } from './aria-DC1XP1AM.mjs';
import { h as useNamespace, f as useId } from './server.mjs';
...
//# sourceMappingURL=el-dropdown-6o5L3AHh.mjs.map

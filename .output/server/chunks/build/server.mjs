import { defineComponent, inject, getCurrentInstance, computed, toValue, onServerPrefetch, ref, unref, shallowRef, provide, cloneVNode, h, createElementBlock, reactive, watch, hasInjectionContext, toRef, nextTick, effectScope, isRef, isReactive, toRaw, getCurrentScope, onScopeDispose, toRefs, markRaw, defineAsyncComponent, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, createVNode, resolveDynamicComponent, isReadonly, isShallow, mergeProps, withCtx, useSSRContext } from 'vue';
import { q as hasProtocol, t as isScriptProtocol, v as joinURL, w as withQuery, x as sanitizeStatusCode, y as getContext, c as createError$1, $ as $fetch$1, z as createHooks, A as executeAsync, B as toRouteMatcher, C as createRouter$1, D as defu } from '../nitro/nitro.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { createHash } from 'node:crypto';
import { isString, isPlainObject as isPlainObject$1 } from '@vue/shared';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-bw84lRY3.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import('./login-BpXbXs1h.mjs')
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import('./index-DdWy-X2d.mjs')
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import('./index-CDzB7GwP.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import('./register-BxBHEGHA.mjs')
  },
  {
    name: "cart-checkout",
    path: "/cart/checkout",
    component: () => import('./checkout-BBJHhF2B.mjs')
  },
  {
    name: "orders-success",
    path: "/orders/success",
    component: () => import('./success-I3nTUr78.mjs')
  },
  {
    name: "productdisplay",
    path: "/productdisplay",
    component: () => import('./productdisplay-CI99SJM8.mjs')
  },
  {
    name: "orders-orderId",
    path: "/orders/:orderId()",
  ...
  },
  {
    name: "profile-userId",
    path: "/profile/:userId()",
    component: () => import('./_userId_-EOi83REy.mjs')
  },
  {
    name: "productId",
    path: "/:productId()",
    component: () => import('./index-hZY3_oX6.mjs')
  },
  {
    name: "productId-itemId",
    path: "/:productId()/:itemId()",
    component: () => import('./_itemId_-Wh1qYcKF.mjs')
  },
  {
    name: "categories-categoryId",
    path: "/categories/:categoryId()",
    component: () => import('./_categoryId_-CILJO20M.mjs')
  }
];
...
function useFetchWithLoading() {
  ...
  const hasError = computed(() => !!error2.value);
  const isIdle = computed(() => !isLoading.value && !error2.value);
  return {
    isLoading,
    error: error2,
    hasError,
...
const useCartStore = /* @__PURE__ */ defineStore("cart", () => {
  const { isLoading, error: error2, fetchData } = useFetchWithLoading();
  const { $toast } = useNuxtApp();
  const cart = ref([]);
  ...
  const fetchCart = async () => {
    try {
      ...
      console.error("Error fetching cart:", error3);
    }
  };
  const addToCart = async (product) => {
    var _a, _b, _c;
    try {
      const { data, error: error3 } = await useFetch("/api/cart/add", {
        method: "POST",
        body: { ...product }
      }, "$l8BZC_jXgH");
      if (error3.value) {
        $toast.error(error3.value);
        return;
      }
      const existingIndex = cart.value.findIndex(
        (item) => item.productId === data.value.cartItem.productId && item.variant === data.value.cartItem.variant && item.bundle === data.value.cartItem.bundle
      );
      if (existingIndex !== -1) {
        cart.value[existingIndex].quantity = (_a = data.value) == null ? void 0 : _a.cartItem.quantity;
        cart.value[existingIndex].price = (_b = data.value) == null ? void 0 : _b.cartItem.price;
      } else {
        cart.value.push((_c = data.value) == null ? void 0 : _c.cartItem);
      }
      updateTotals();
  ...
  const incrementCartItem = async ({ productId, bundle, variant }) => {
    ...
    if (itemIndex !== -1) {
      ...
      cart.value[itemIndex].quantity = (_a = data.value) == null ? void 0 : _a.cartItem.quantity;
      cart.value[itemIndex].price = (_b = data.value) == null ? void 0 : _b.cartItem.price;
      updateTotals();
    }
  };
  const decrementCartItem = async ({ productId, bundle, variant }) => {
    ...
    if (itemIndex !== -1) {
      ...
      if (((_a = data.value) == null ? void 0 : _a.cartItem.quantity) <= 0) {
        ...
        cart.value[itemIndex].quantity = (_b = data.value) == null ? void 0 : _b.cartItem.quantity;
        cart.value[itemIndex].price = (_c = data.value) == null ? void 0 : _c.cartItem.price;
      }
      updateTotals();
    }
  };
      ...
      try {
        ...
        const response = await $fetch("/api/user", {
          ...
          onResponseError: (context) => {
            var _a, _b;
            if (((_a = error.response) == null ? void 0 : _a.status) === 401 || ((_b = error.response) == null ? void 0 : _b.status) === 403) {
              this.isAuthenticated = false;
              this.user = null;
              return false;
            }
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DAGMomti.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DpGq3x15.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bug6msso.mjs'));
...
export { isPropAbsent as A, useIdInjection as B, isElement as C, useAsyncData as D, useGetDerivedNamespace as E, __nuxt_component_4 as _, useNamespace as a, useAuthStore as b, useCartStore as c, debugWarn as d, entry$1 as default, throwError as e, useId as f, useRouter as g, useNuxtApp as h, isBoolean as i, useRuntimeConfig as j, nuxtLinkDefaults as k, defineStore as l, useFetchWithLoading as m, navigateTo as n, useFetch as o, isNumber as p, isStringNumber as q, resolveRouteObject as r, isUndefined as s, tryUseNuxtApp as t, useRoute as u, defaultNamespace as v, useZIndex as w, defaultInitialZIndex as x, namespaceContextKey as y, zIndexContextKey as z };

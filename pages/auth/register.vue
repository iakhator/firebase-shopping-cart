  ...
  <el-card class="auth-card" shadow="hover">
    ...
    >
      ...
      <el-form-item prop="acceptTerms" class="form-item">
        <el-checkbox v-model="registerForm.acceptTerms" class="terms-checkbox">
          I agree to the
          <el-link type="primary" class="terms-link">
            Terms of Service
          </el-link>
          and
          <el-link type="primary" class="terms-link"> Privacy Policy </el-link>
        </el-checkbox>
      </el-form-item>
    ...
    <div class="auth-footer">
      ...
      <el-link type="primary" class="signin-link" @click="navigateToSignIn">
        Sign in
      </el-link>
    </div>
  </el-card>

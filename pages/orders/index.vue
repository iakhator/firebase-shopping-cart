  ...
  <div class="order-list-container">
    ...
    <div class="mb-4">
      ...
      <p class="text-gray-600">
        View and manage all your orders, track shipments, and review your
        purchase history.
      </p>
    </div>
            ...
            <div class="order-details-content">
                ...
                <div class="order-items">
                  ...
                  >
                    ...
                    <div class="item-price">
                      <p>
                        {{ toUSD(item.price * item.quantity) }}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div class="info-section">
                ...
                <div class="address-info">
                  ...
                  <p>
                    {{
                      countryMap[order.shippingAddress.country] ||
              ...
              <div class="info-grid">
                ...
                <div v-if="order?.estimatedDelivery" class="info-section">
                  <h4 class="info-section-title">
                    <el-icon><Calendar /></el-icon>
                    Estimated Delivery
                  </h4>
                  <p>
                    {{ $dayjs(order.estimatedDelivery).format('MMMM D, YYYY') }}
                  </p>
                </div>
              </div>

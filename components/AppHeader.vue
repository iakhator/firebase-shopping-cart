        ...
        <div class="desktop-menu">
          <ClientOnly>
            <el-menu-item
              ...
              role="button"
              @click="
                isAuthenticated ? toggleDrawer() : navigateTo('/auth/login')
              "
    ...
    <el-drawer v-model="profileOpen" direction="rtl" id="mobile-menu">
      <div class="profile-content">
        ...
        <div class="el-menu-link">
          <NuxtLink class="link" :to="`/user/${uid}`" @click="toggleDrawer">
            <el-icon><Avatar /></el-icon><span>Profile</span></NuxtLink
          >
          <NuxtLink class="link" to="/orders" @click="toggleDrawer"
            ><el-icon><Grid /></el-icon><span>View Orders</span></NuxtLink
          >
          <NuxtLink class="link" to="/about" @click="toggleDrawer"
            ><el-icon><Setting /></el-icon> <span>Preference</span></NuxtLink
          >
        </div>
      </div>
      <UIButton

  ...
  <div class="space-y-6">
    <ElCard>
      <template #header>
        ...
        <div class="text-gray-500 text-sm">Manage your shipping addresses</div>
      </template>
      <div class="space-y-4">
        <div
        ...
        >
          <div class="flex items-start justify-between mb-2">
            <div>
              ...
              <ElTag v-if="address.default" type="success" class="text-xs"
                >Default</ElTag
              >
            </div>
      ...
      <div class="space-y-4">
        <ElFormItem label="Default Shipping Speed">
          <ElSelect v-model="shipping.preferences.speed" size="large">
            <ElOption label="Standard (5-7 days)" value="standard" />

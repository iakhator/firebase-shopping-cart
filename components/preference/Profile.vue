      ...
      <div class="space-y-6">
        <div class="flex items-center gap-6">
          <div class="avatar-upload">
            ...
            <ElButton circle size="small" class="avatar-upload-button">
              <IconCamera size="15" />
            </ElButton>
          </div>
          <div>
            <h3 class="font-semibold">Profile Picture</h3>
            <p class="text-sm text-gray-600 mb-2">JPG, GIF or PNG. 1MB max.</p>
            <ElButton type="default" size="small">Upload new picture</ElButton>
          </div>
        </div>
        <ElDivider />
        <ElForm label-position="top" class="grid grid-cols-1">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <ElFormItem label="Email">
              <ElInput v-model="profile.email" type="email" size="large" />
            </ElFormItem>
